...
- Grant: [Rheinwerk Verlag GmbH](https://www.rheinwerk-verlag.de)
 - The Rheinwerk Verlag publishes IT-related literature on various topics. The Meshtastic logo and trademark are used on the cover of publication on Meshtastic. The use of the term "Meshtastic" and the logo does not imply sponsorshop, support or official endorsement by the Meshtastic project.
